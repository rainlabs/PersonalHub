...
const SmallCard: FC<CardInfo> = ({image, topic, title, children}) => {
    return (
        <div className="group w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink  transform transition duration-500 hover:scale-100 md:hover:scale-110" >
